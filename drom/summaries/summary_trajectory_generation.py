...
from drom.models import build_context
from drom.summaries.summary_base import SummaryBase
...
class SummaryTrajectoryGeneration(SummaryBase):
    ...
    def summary_fn(self, train_step=None, model=None, datasubset=None, prefix='', debug=False, **kwargs):
        ...
        # print("fig_joint_trajs_dataset: " + str(fig_joint_trajs_dataset))
        # print("fig_robot_trajs_dataset: " + str(fig_robot_trajs_dataset))
        # diffusion trajectory
        # print("\nSummary")
        # print("trajs: " + str(trajs.size()))
        start_state_pos = trajs[0][0]
        # print("start_state_pos: " + str(start_state_pos.size()))
        goal_state_pos = trajs[0][-1]
